...
def add_new_user():
    ...
    new_user = new_user + [first_name, last_name, email, username, hashed_password_encoded, salt_encoded, bio, role]

    try:
        admin.execute("INSERT INTO user_info (first_name, last_name, email, user_name, hashed_password, salt_code, bio, role) VALUES(?,?,?,?,?,?,?,?)", new_user)
        data_base.commit()
...
#     for user in users:
#         try:
#             admin.execute("INSERT INTO user_info (first_name, last_name, email, user_name, hash, salt_encode, bio, role) VALUES(?,?,?,?,?,?,?,?)", user)
#             data_base.commit()
